        ...
        <div class="search-group-wrap">
          <div class="search-group">
            ...
            <FormItem :label="$t('listModule.personnel.userQuery')">
              <Select   v-model="searchForm.col_company" style="width:200px">
    ...
    return {
      ...
      tableDefine1: [
        { title: this.$t("listModule.personnel.date"), align: 'center', key: 'days', width: 130, fixed: 'left'  },
         ...
         { title: this.$t("listModule.personnel.allRecycle"), align: 'center', key: 'num', width: 130 },
          { title: this.$t("listModule.personnel.allRate"), align: 'center', key: 'num', width: 130 },
